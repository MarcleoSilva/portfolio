...
export default function AchievementBlock({ title, link, position, event, resume, tags }:
    { title: string; link: string; position: string; event: string; resume: string; tags: string[] }) {
  ...
  return (
    ...
    >
      ...
      <h3 className="text-base font-semibold text-yellow-400">{position} — {event}</h3>
